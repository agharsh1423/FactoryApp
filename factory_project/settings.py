...
SECRET_KEY = config('SECRET_KEY', default='django-insecure--py^puuq84s#q9utwte5*zaix5n)hdax0ell3@nt6^$+q*^31y')
...
INSTALLED_APPS = [
    ...
    'consignment',  # Our consignment management app
]
...
# Use DATABASE_URL environment variable for PostgreSQL (Supabase)
